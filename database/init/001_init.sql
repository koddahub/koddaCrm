...
CREATE TABLE IF NOT EXISTS client.subscriptions (
  ...
  billing_profile_updated_at TIMESTAMPTZ,
...
CREATE INDEX IF NOT EXISTS idx_subscription_change_schedule_status_effective ON client.subscription_change_schedule(status, effective_at);
CREATE INDEX IF NOT EXISTS idx_subscription_change_schedule_subscription ON client.subscription_change_schedule(subscription_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_plan_change_payment_sessions_subscription ON client.plan_change_payment_sessions(subscription_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_plan_change_payment_sessions_status ON client.plan_change_payment_sessions(status, created_at DESC);
