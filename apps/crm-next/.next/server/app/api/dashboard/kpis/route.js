"use strict";(()=>{var e={};e.id=1870,e.ids=[1870],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5830:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>_,patchFetch:()=>m,requestAsyncStorage:()=>A,routeModule:()=>N,serverHooks:()=>T,staticGenerationAsyncStorage:()=>p});var s={};a.r(s),a.d(s,{GET:()=>u});var n=a(3278),r=a(5002),i=a(4877),o=a(1309),c=a(7392),l=a(85),E=a(6753),d=a(4738);async function u(e){let t=(0,c.I)(e);if(t)return t;await (0,l.e)();let a=new Date,s=new Date(a.getTime()-864e5),n=new Date(a.getTime()-6048e5),[r,i,u,N,A,p,T,_,m,I,O]=await Promise.all([d._.lead.count({where:{createdAt:{gte:s}}}),d._.lead.count({where:{createdAt:{gte:n}}}),d._.signupSession.count({where:{status:"ABANDONED",paymentConfirmed:!1}}),d._.deal.count({where:{dealType:"HOSPEDAGEM",lifecycleStatus:"CLIENT",updatedAt:{gte:n}}}),d._.deal.count({where:{dealType:"PROJETO_AVULSO",lifecycleStatus:"CLIENT",updatedAt:{gte:n}}}),d._.deal.count({where:{lifecycleStatus:"LOST",updatedAt:{gte:n}}}),d._.$queryRaw`
      SELECT
        COUNT(*) FILTER (
          WHERE (
            CASE
    ...
    `,d._.dealOperation.count({where:{status:"ACTIVE"}}),d._.deal.count({where:{lifecycleStatus:{not:"CLIENT"},slaDeadline:{lt:a}}}),d._.ticketQueue.count({where:{status:{in:["NEW","OPEN","PENDING"]}}}),(0,E.a)()]),L=T[0]||{ativos:0,atrasados:0,inativos:0,fantasma:0};return o.NextResponse.json({prospeccao:{leads24h:r,leads7d:i,abandonos2h:u,ganhosHospedagem:N,ganhosAvulsos:A,perdidos:p},operacao:{clientesAtivos:L.ativos,clientesAtrasados:L.atrasados,clientesInativos:L.inativos,clientesFantasma:L.fantasma,operacoesEmCurso:_,slaRisco:m,ticketsAbertos:I},financeiro:{mrr:O.mrr,recebidosMes:O.recebidosMes,inadimplenciaAberta:O.inadimplenciaAberta,dreResultadoMes:O.dre.resultado}})}let N=new n.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/dashboard/kpis/route",pathname:"/api/dashboard/kpis",filename:"route",bundlePath:"app/api/dashboard/kpis/route"},resolvedPagePath:"/home/server/projects/projero-area-cliente/apps/crm-next/app/api/dashboard/kpis/route.ts",nextConfigOutput:"standalone",userland:s}),{requestAsyncStorage:A,staticGenerationAsyncStorage:p,serverHooks:T}=N,_="/api/dashboard/kpis/route";function m(){return(0,i.patchFetch)({serverHooks:T,staticGenerationAsyncStorage:p})}},7392:(e,t,a)=>{a.d(t,{I:()=>n});var s=a(1309);function n(e){return e.cookies.get("crm_admin_session")?.value!==(process.env.CRM_ADMIN_SESSION_TOKEN||"koddahub-crm-v2-session")?s.NextResponse.json({error:"Nao autorizado"},{status:401}):null}},85:(e,t,a)=>{a.d(t,{e:()=>o,u:()=>n});var s=a(4738);let n={ATIVO:"ATIVO",ATRASADO:"ATRASADO",INATIVO:"INATIVO"};function r(e){return e.toISOString().slice(0,10)}function i(e,t){return new Date(e.getTime()+864e5*t)}async function o(){for(let e of(await s._.$executeRawUnsafe(`
  ...
  `),[2026,2027,2028,2029,2030]))for(let t of function(e){let t=function(e){let t=e%19,a=Math.floor(e/100),s=e%100,n=(19*t+a-Math.floor(a/4)-Math.floor((a-Math.floor((a+8)/25)+1)/3)+15)%30,r=(32+a%4*2+2*Math.floor(s/4)-n-s%4)%7,i=Math.floor((t+11*n+22*r)/451);return new Date(Date.UTC(e,Math.floor((n+r-7*i+114)/31)-1,(n+r-7*i+114)%31+1))}(e),a=i(t,-48),s=i(t,-47),n=i(t,-2),o=i(t,60);return[{date:`${e}-01-01`,name:"Confraterniza\xe7\xe3o Universal"},{date:r(a),name:"Carnaval (segunda-feira)"},{date:r(s),name:"Carnaval (ter\xe7a-feira)"},{date:r(n),name:"Sexta-feira Santa"},{date:`${e}-04-21`,name:"Tiradentes"},{date:`${e}-05-01`,name:"Dia do Trabalho"},{date:r(o),name:"Corpus Christi"},{date:`${e}-09-07`,name:"Independ\xeancia do Brasil"},{date:`${e}-10-12`,name:"Nossa Senhora Aparecida"},{date:`${e}-11-02`,name:"Finados"},{date:`${e}-11-15`,name:"Proclama\xe7\xe3o da Rep\xfablica"},{date:`${e}-11-20`,name:"Dia da Consci\xeancia Negra"},{date:`${e}-12-25`,name:"Natal"}]}(e))await s._.$executeRawUnsafe(`
          INSERT INTO crm.holiday_calendar (holiday_date, name, scope)
          VALUES ($1::date, $2::varchar, 'NACIONAL')
          ON CONFLICT (holiday_date) DO NOTHING
        `,t.date,t.name)}},6753:(e,t,a)=>{a.d(t,{a:()=>c});var s=a(3524),n=a(4738),r=a(7844);let i=["CONFIRMED","RECEIVED","PAID","RECEIVED_IN_CASH","SETTLED"];async function o(e){let t=await n._.$queryRaw(e);return(0,r.jW)(t[0]?.total??null)}async function c(){let{start:e,end:t}=function(e=new Date){return{start:new Date(e.getFullYear(),e.getMonth(),1),end:new Date(e.getFullYear(),e.getMonth()+1,1)}}(),[a,n,r,c,l,E]=await Promise.all([o(s.Prisma.sql`
    ...
    `),o(s.Prisma.sql`
      ...
      WHERE p.paid_at >= ${e}::timestamp
        ...
        AND p.status = ANY(${i}::text[])
    `),o(s.Prisma.sql`
      SELECT COALESCE(SUM(p.amount), 0) AS total
      FROM client.payments p
      WHERE p.due_date < CURRENT_DATE
        AND (p.status IS NULL OR p.status <> ALL(${i}::text[]))
    `),o(s.Prisma.sql`
    ...
    `),o(s.Prisma.sql`
      ...
      WHERE fe.entry_type = 'DESPESA'
        AND fe.entry_date >= ${e}::date
        AND fe.entry_date < ${t}::date
    `)]),d=c+l,u=d>0?d:Math.round(.15*n);return{mrr:a,recebidosMes:n,inadimplenciaAberta:r,avulsoMes:d,dre:{receitaRecorrente:n,receitaAvulsa:d,despesasManuais:E,resultado:n+d-E},projecao:{d30:a+u,d60:2*a+2*u,d90:3*a+3*u}}}},7844:(e,t,a)=>{function s(e){return Number.isFinite(e)?Math.round(100*e):0}function n(e){return null==e?0:"number"==typeof e?s(e):s(Number(String(e).trim().replace(/\./g,"").replace(",",".")))}function r(e){return null==e?0:"number"==typeof e?s(e):s(e.toNumber())}a.d(t,{jW:()=>r,yv:()=>n})},4738:(e,t,a)=>{a.d(t,{_:()=>n});var s=a(3524);let n=global.__prisma__??new s.PrismaClient({log:["error"]})}};var t=require("../../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),s=t.X(0,[7787,4833],()=>a(5830));module.exports=s})();