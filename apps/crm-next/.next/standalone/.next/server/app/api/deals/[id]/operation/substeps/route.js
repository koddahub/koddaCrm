"use strict";(()=>{var e={};e.id=5620,e.ids=[5620],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5315:e=>{e.exports=require("path")},1100:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>T,patchFetch:()=>N,requestAsyncStorage:()=>E,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>p});var r={};a.r(r),a.d(r,{GET:()=>l});var o=a(3278),i=a(5002),d=a(4877),s=a(1309),n=a(7392),_=a(4738),u=a(1043);async function l(e,{params:t}){let a=(0,n.I)(e);if(a)return a;if("publicacao"!==(e.nextUrl.searchParams.get("stage")||"publicacao").trim().toLowerCase())return s.NextResponse.json({error:"Sub-etapas dispon\xedveis apenas para o est\xe1gio publicacao nesta vers\xe3o."},{status:422});let r=await _._.deal.findUnique({where:{id:t.id},select:{id:!0,dealType:!0,lifecycleStatus:!0}});if(!r)return s.NextResponse.json({error:"Deal n\xe3o encontrado"},{status:404});if("HOSPEDAGEM"!==r.dealType)return s.NextResponse.json({error:"Sub-etapas dispon\xedveis apenas para hospedagem."},{status:422});await (0,u.js)(r.id);let o=await (0,u.LO)(r.id),i=await (0,u.wP)(r.id);return s.NextResponse.json({ok:!0,stage:"publicacao",summary:i,items:o})}let c=new o.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/deals/[id]/operation/substeps/route",pathname:"/api/deals/[id]/operation/substeps",filename:"route",bundlePath:"app/api/deals/[id]/operation/substeps/route"},resolvedPagePath:"/home/server/projects/projero-area-cliente/apps/crm-next/app/api/deals/[id]/operation/substeps/route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:E,staticGenerationAsyncStorage:p,serverHooks:m}=c,T="/api/deals/[id]/operation/substeps/route";function N(){return(0,d.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:p})}},7392:(e,t,a)=>{a.d(t,{I:()=>o});var r=a(1309);function o(e){return e.cookies.get("crm_admin_session")?.value!==(process.env.CRM_ADMIN_SESSION_TOKEN||"koddahub-crm-v2-session")?r.NextResponse.json({error:"Nao autorizado"},{status:401}):null}},4738:(e,t,a)=>{a.d(t,{_:()=>o});var r=a(3524);let o=global.__prisma__??new r.PrismaClient({log:["error"]})},1043:(e,t,a)=>{a.d(t,{Bv:()=>m,CQ:()=>c,Df:()=>l,LO:()=>N,UH:()=>E,Ug:()=>p,VW:()=>u,js:()=>T,wP:()=>L});var r=a(5315),o=a.n(r),i=a(4738);let d=process.env.SITE24H_TEMPLATE_LIBRARY_ROOT||"/home/server/projects/projero-area-cliente/storage/site-models",s=[{code:"dominio_decisao",name:"Dom\xednio j\xe1 existe / precisa contratar",order:1,required:!0},{code:"dominio_registro",name:"Registro/transfer\xeancia de dom\xednio",order:2,required:!0},{code:"dns_config",name:"Configura\xe7\xe3o de DNS e apontamentos",order:3,required:!0},{code:"hostgator_account",name:"Cadastro/ajuste na Hostgator",order:4,required:!0},{code:"deploy_ssl",name:"Deploy + SSL + valida\xe7\xe3o t\xe9cnica",order:5,required:!0},{code:"go_live_monitor",name:"Monitoramento de entrada no ar",order:6,required:!0}],n=!1,_=[{code:"template_v1_institucional_1pagina",name:"V1 - Institucional 1 p\xe1gina",folder:"template_v1_institucional_1pagina",entryFile:"index.html",isDefault:!0},{code:"template_v2_institucional_3paginas",name:"V2 - Institucional 3 p\xe1ginas",folder:"template_v2_institucional_3paginas",entryFile:"index.html",isDefault:!1},{code:"template_v3_institucional_chatbot",name:"V3 - Institucional com chatbot",folder:"template_v3_institucional_chatbot",entryFile:"index.html",isDefault:!1}];function u(e){let t=o().resolve(String(e||"").trim());if(!t)throw Error("Caminho do modelo \xe9 obrigat\xf3rio");if(!function(e,t){let a=o().resolve(t),r=o().resolve(e);return r===a||r.startsWith(`${a}${o().sep}`)}(t,d))throw Error(`Caminho do modelo deve estar dentro de ${d}`);return t}function l(){return"Host server\n    HostName ssh.koddahub.com.br\n    User server\n    ProxyCommand cloudflared access ssh --hostname %h\n    IdentityFile ~/.ssh/id_rsa\n    ServerAliveInterval 30\n    StrictHostKeyChecking no\n    UserKnownHostsFile /dev/null\n    ConnectTimeout 180"}async function c(){if(!n){for(let e of(await i._.$executeRawUnsafe(`
  ...
  `),_)){let t=u(o().resolve(d,e.folder));await i._.$queryRaw`
