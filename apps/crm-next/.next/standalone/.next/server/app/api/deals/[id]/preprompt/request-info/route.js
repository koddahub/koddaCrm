"use strict";(()=>{var e={};e.id=7604,e.ids=[7604],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5315:e=>{e.exports=require("path")},6605:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>A,patchFetch:()=>R,requestAsyncStorage:()=>m,routeModule:()=>E,serverHooks:()=>N,staticGenerationAsyncStorage:()=>T});var i={};a.r(i),a.d(i,{POST:()=>p});var r=a(3278),d=a(5002),o=a(4877),s=a(1309),n=a(7392),l=a(9004),_=a(1043),c=a(4738);async function u(e){return(await c._.$queryRaw`
  ...
  `),n=!0}}async function p(){return await u(),(await d._.$queryRaw`
  ...
  `).map(e=>({id:e.id,code:e.code,name:e.name,rootPath:e.root_path,entryFile:e.entry_file,isDefault:e.is_default,isActive:e.is_active,createdAt:e.created_at,updatedAt:e.updated_at}))}async function E(e){await u();let t=e.code.trim().toLowerCase().replace(/[^a-z0-9_-]/g,"_");if(!t)throw Error("C\xf3digo do modelo inv\xe1lido");let a=e.name.trim();if(!a)throw Error("Nome do modelo \xe9 obrigat\xf3rio");let i=_(e.rootPath),r=(e.entryFile||"index.html").replace(/^\/+/,"").trim()||"index.html",o=!!e.isDefault,s=void 0===e.isActive||!!e.isActive;o&&await d._.$executeRaw`UPDATE crm.template_model_catalog SET is_default=false, updated_at=now()`;let n=await d._.$queryRaw`
    ...
    DO UPDATE SET
      ...
      updated_at = now()
    RETURNING id::text
  `;return n[0]?.id||null}async function m(e){await u();let t=String(e||"").trim().toLowerCase(),a=t?await d._.$queryRaw`
      ...
      `:await d._.$queryRaw`
        ...
        LIMIT 1
      `;return a[0]?{id:a[0].id,code:a[0].code,name:a[0].name,rootPath:a[0].root_path,entryFile:a[0].entry_file,isDefault:a[0].is_default}:null}async function T(e){for(let t of(await u(),s))await d._.$executeRaw`
  ...
  `}async function A(e){await u();let t=(await d._.$queryRaw`
    SELECT
