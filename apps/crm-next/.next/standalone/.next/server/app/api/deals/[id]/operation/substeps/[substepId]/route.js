"use strict";(()=>{var e={};e.id=4019,e.ids=[4019],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5315:e=>{e.exports=require("path")},7537:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>A,patchFetch:()=>m,requestAsyncStorage:()=>T,routeModule:()=>c,serverHooks:()=>N,staticGenerationAsyncStorage:()=>p});var r={};a.r(r),a.d(r,{PATCH:()=>E});var i=a(3278),o=a(5002),s=a(4877),d=a(1309),_=a(7392),n=a(4738),u=a(1043);let l=new Set(["PENDING","IN_PROGRESS","COMPLETED","SKIPPED","BLOCKED"]);async function E(e,{params:t}){let a=(0,_.I)(e);if(a)return a;let r=await e.json().catch(()=>({})),i=String(r.status||"").trim().toUpperCase(),o=void 0===r.owner?void 0:String(r.owner||"").trim(),s=void 0===r.notes?void 0:String(r.notes||"").trim();if(i&&!l.has(i))return d.NextResponse.json({error:"Status de sub-etapa inv\xe1lido."},{status:422});try{let e=await n._.$transaction(async e=>{let a=(await e.$queryRaw`
        ...
        LIMIT 1
      `)[0];if(!a)throw Error("Sub-etapa n\xe3o encontrada");if("publicacao"!==a.stage_code)throw Error("Somente sub-etapas de publica\xe7\xe3o s\xe3o suportadas nesta vers\xe3o");let r=new Date,d=i||a.status,_={status:d,owner:void 0===o?void 0:o||null,notes:void 0===s?void 0:s||null,startedAt:"IN_PROGRESS"===d?r:void 0,completedAt:["COMPLETED","SKIPPED"].includes(d)?r:void 0,updatedAt:r};return await e.$executeRaw`
        UPDATE crm.deal_operation_substep
        SET
          status = ${_.status},
          owner = COALESCE(${_.owner??null}, owner),
          notes = COALESCE(${_.notes??null}, notes),
          started_at = CASE
            WHEN ${!!_.startedAt} = true AND started_at IS NULL THEN ${_.startedAt??null}
            ELSE started_at
          END,
          completed_at = CASE
            WHEN ${!!_.completedAt} = true THEN ${_.completedAt??null}
            ELSE completed_at
          END,
          updated_at = now()
        WHERE id = ${t.substepId}::uuid
      `,await e.dealActivity.create({data:{dealId:t.id,activityType:"PUBLICATION_SUBSTEP_UPDATED",content:`Sub-etapa "${a.substep_name}" atualizada para ${d}.`,metadata:{substepId:t.substepId,stageCode:"publicacao",status:d,owner:o||null},createdBy:"ADMIN"}}),{ok:!0,substepId:t.substepId,status:d}}),a=await (0,u.wP)(t.id);return a.ready&&await n._.dealActivity.create({data:{dealId:t.id,activityType:"PUBLICATION_READY",content:"Todas as sub-etapas obrigat\xf3rias de publica\xe7\xe3o foram conclu\xeddas. Monitor estrito est\xe1 ativo.",metadata:a,createdBy:"SYSTEM"}}),d.NextResponse.json({...e,summary:a})}catch(e){return d.NextResponse.json({error:"Falha ao atualizar sub-etapa",details:String(e)},{status:500})}}let c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/deals/[id]/operation/substeps/[substepId]/route",pathname:"/api/deals/[id]/operation/substeps/[substepId]",filename:"route",bundlePath:"app/api/deals/[id]/operation/substeps/[substepId]/route"},resolvedPagePath:"/home/server/projects/projero-area-cliente/apps/crm-next/app/api/deals/[id]/operation/substeps/[substepId]/route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:T,staticGenerationAsyncStorage:p,serverHooks:N}=c,A="/api/deals/[id]/operation/substeps/[substepId]/route";function m(){return(0,s.patchFetch)({serverHooks:N,staticGenerationAsyncStorage:p})}},7392:(e,t,a)=>{a.d(t,{I:()=>i});var r=a(1309);function i(e){return e.cookies.get("crm_admin_session")?.value!==(process.env.CRM_ADMIN_SESSION_TOKEN||"koddahub-crm-v2-session")?r.NextResponse.json({error:"Nao autorizado"},{status:401}):null}},4738:(e,t,a)=>{a.d(t,{_:()=>i});var r=a(3524);let i=global.__prisma__??new r.PrismaClient({log:["error"]})},1043:(e,t,a)=>{a.d(t,{Bv:()=>p,CQ:()=>E,Df:()=>l,LO:()=>A,UH:()=>c,Ug:()=>T,js:()=>N,wP:()=>m});var r=a(5315),i=a.n(r),o=a(4738);let s=process.env.SITE24H_TEMPLATE_LIBRARY_ROOT||"/home/server/projects/projero-area-cliente/storage/site-models",d=[{code:"dominio_decisao",name:"Dom\xednio j\xe1 existe / precisa contratar",order:1,required:!0},{code:"dominio_registro",name:"Registro/transfer\xeancia de dom\xednio",order:2,required:!0},{code:"dns_config",name:"Configura\xe7\xe3o de DNS e apontamentos",order:3,required:!0},{code:"hostgator_account",name:"Cadastro/ajuste na Hostgator",order:4,required:!0},{code:"deploy_ssl",name:"Deploy + SSL + valida\xe7\xe3o t\xe9cnica",order:5,required:!0},{code:"go_live_monitor",name:"Monitoramento de entrada no ar",order:6,required:!0}],_=!1,n=[{code:"template_v1_institucional_1pagina",name:"V1 - Institucional 1 p\xe1gina",folder:"template_v1_institucional_1pagina",entryFile:"index.html",isDefault:!0},{code:"template_v2_institucional_3paginas",name:"V2 - Institucional 3 p\xe1ginas",folder:"template_v2_institucional_3paginas",entryFile:"index.html",isDefault:!1},{code:"template_v3_institucional_chatbot",name:"V3 - Institucional com chatbot",folder:"template_v3_institucional_chatbot",entryFile:"index.html",isDefault:!1}];function u(e){let t=i().resolve(String(e||"").trim());if(!t)throw Error("Caminho do modelo \xe9 obrigat\xf3rio");if(!function(e,t){let a=i().resolve(t),r=i().resolve(e);return r===a||r.startsWith(`${a}${i().sep}`)}(t,s))throw Error(`Caminho do modelo deve estar dentro de ${s}`);return t}function l(){return"Host server\n    HostName ssh.koddahub.com.br\n    User server\n    ProxyCommand cloudflared access ssh --hostname %h\n    IdentityFile ~/.ssh/id_rsa\n    ServerAliveInterval 30\n    StrictHostKeyChecking no\n    UserKnownHostsFile /dev/null\n    ConnectTimeout 180"}async function E(){if(!_){for(let e of(await o._.$executeRawUnsafe(`
  ...
  `),n)){let t=u(i().resolve(s,e.folder));await o._.$queryRaw`
  ...
  `),_=!0}}async function c(){return await E(),(await o._.$queryRaw`
  ...
  `).map(e=>({id:e.id,code:e.code,name:e.name,rootPath:e.root_path,entryFile:e.entry_file,isDefault:e.is_default,isActive:e.is_active,createdAt:e.created_at,updatedAt:e.updated_at}))}async function T(e){await E();let t=e.code.trim().toLowerCase().replace(/[^a-z0-9_-]/g,"_");if(!t)throw Error("C\xf3digo do modelo inv\xe1lido");let a=e.name.trim();if(!a)throw Error("Nome do modelo \xe9 obrigat\xf3rio");let r=u(e.rootPath),i=(e.entryFile||"index.html").replace(/^\/+/,"").trim()||"index.html",s=!!e.isDefault,d=void 0===e.isActive||!!e.isActive;s&&await o._.$executeRaw`UPDATE crm.template_model_catalog SET is_default=false, updated_at=now()`;let _=await o._.$queryRaw`
    ...
    DO UPDATE SET
      ...
      updated_at = now()
    RETURNING id::text
  `;return _[0]?.id||null}async function p(e){await E();let t=String(e||"").trim().toLowerCase(),a=t?await o._.$queryRaw`
      ...
      `:await o._.$queryRaw`
        ...
        LIMIT 1
      `;return a[0]?{id:a[0].id,code:a[0].code,name:a[0].name,rootPath:a[0].root_path,entryFile:a[0].entry_file,isDefault:a[0].is_default}:null}async function N(e){for(let t of(await E(),d))await o._.$executeRaw`
    ...
    `}async function A(e){return await E(),o._.$queryRaw`
    SELECT
      id::text,
      deal_id::text,
      stage_code,
  ...
  `}async function m(e){await E();let t=(await o._.$queryRaw`
    SELECT
