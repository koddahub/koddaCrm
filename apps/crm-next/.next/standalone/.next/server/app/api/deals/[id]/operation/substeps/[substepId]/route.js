"use strict";(()=>{var e={};e.id=4019,e.ids=[4019],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5315:e=>{e.exports=require("path")},6529:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>m,patchFetch:()=>A,requestAsyncStorage:()=>T,routeModule:()=>c,serverHooks:()=>N,staticGenerationAsyncStorage:()=>p});var r={};a.r(r),a.d(r,{PATCH:()=>l});var o=a(3278),s=a(5002),i=a(4877),d=a(1309),_=a(7392),n=a(4738),u=a(1043);let E=new Set(["PENDING","IN_PROGRESS","COMPLETED","SKIPPED","BLOCKED"]);async function l(e,{params:t}){let a=(0,_.I)(e);if(a)return a;let r=await e.json().catch(()=>({})),o=String(r.status||"").trim().toUpperCase(),s=void 0!==r.owner,i=void 0!==r.notes,l=s?String(r.owner||"").trim():void 0,c=i?String(r.notes||"").trim():void 0;if(o&&!E.has(o))return d.NextResponse.json({error:"Status de sub-etapa inv\xe1lido."},{status:422});try{let e=await n._.$transaction(async e=>{let a=(await e.$queryRaw`
